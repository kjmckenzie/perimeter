...
{
   /// <summary>
   /// Lookup a company name for a given ID. Company identifiers are unique numbers assigned by the Bluetooth SIG to member
   ...
   public static class RegisteredCompanyIds
   {
      ...
      private static readonly IDictionary<UInt16, String> s_values = new Dictionary<UInt16, String>
      {
         ...
         {0xFFFF, "Internal/None"}
      };

      /// <summary>
      /// Iterate over all the registered companies
      /// </summary>
